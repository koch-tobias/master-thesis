...
# %%
def get_model_folder_path(binary_model: bool, folder_path: str) -> str:
    ''' 
...
def k_fold_crossvalidation(X: np.array, y: np.array, X_test: np.array, y_test: np.array, weight_factor: float or dict, df: pd.DataFrame, model_results_dict: dict, folder_path: str, method: str, binary_model: bool) -> pd.DataFrame:
    ''' 
