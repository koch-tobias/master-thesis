...
from src.data_preparation_pipeline.data_preparation import data_preparation
from src.data_preprocessing_pipeline.feature_engineering import add_new_features
from src.data_preprocessing_pipeline.data_cleaning import clean_dataset
from src.data_preprocessing_pipeline.feature_engineering import find_valid_space
...
def classification_on_new_data(df: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame, list, str]:
    ...
    df, ncar = data_preparation(dataframe=df)
