...
general_params = {
    ...
    "relevant_features": ['Sachnummer','Benennung (dt)', 'X-Min','X-Max','Y-Min','Y-Max','Z-Min','Z-Max', 'Wert','Einheit','Gewichtsart','Kurzname','L-Kz.', 'L/R-Kz.', 'Modul (Nr)', 'Code', 'ox','oy', 'oz', 'xx','xy','xz', 'yx','yy','yz','zx','zy','zz'], # List of features which are relevant for the models - all other features will be deleted
    ...
    "keep_modules": ['FBEP', 'CE05', 'CD07'], # Keep this modules out of module group EP, CE05=interior mirror, and CD07=roof antenna
...
train_settings = {
    ...
    "ml-method": "catboost",        # Choose between 'lgbm', 'xgboost' and 'catboost'
